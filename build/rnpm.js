    ...
    _createClass(MenuOptions, [{
      ...
      value: function render() {
        var _this$props = this.props,
            ...
            otherProps = _objectWithoutProperties(_this$props, ["customStyles", "style", "children"]);
    ...
    _createClass(MenuOption, [{
      ...
      value: function render() {
        ...
        var _this$props = this.props,
            ...
            style = _this$props.style,
            testID = _this$props.testID,
            otherProps = _objectWithoutProperties(_this$props, ["text", "disabled", "disableTouchable", "children", "style", "testID"]);
        ...
        if (disabled) {
          ...
          }, otherProps), text ? React__default.createElement(reactNative.Text, {
            style: disabledStyles
          }, text) : children);
        }

        var rendered = React__default.createElement(reactNative.View, _extends({
          style: [defaultStyles.option, customStyles.optionWrapper, style]
        }, otherProps), text ? React__default.createElement(reactNative.Text, {
        ...
        if (disableTouchable) {
          ...
          }, defaultTouchableProps, customStyles.optionTouchable, otherProps), rendered);
        }
      }
    }]);
