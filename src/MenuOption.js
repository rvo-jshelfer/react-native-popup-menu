...
export class MenuOption extends Component {
  ...
  render() {
    const { text, disabled, disableTouchable, children, style, testID, ...otherProps } = this.props;
    ...
    if (disabled) {
      ...
      return (
        <View style={[defaultStyles.option, customStyles.optionWrapper, style]} {...otherProps}>
